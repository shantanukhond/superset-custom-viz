...
//   it('exists', () => {
//     expect(VennDiagram).toBeDefined();
//   });
// });
describe("Always true test", () => {
  it("should always be true", () => {
    const value = true; // The value is always true
    expect(value).toBe(true); // This assertion will always pass
  });
});
